...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/tigermed-jimmy/tigermed-multica/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/tigermed-jimmy/tigermed-multica.git"
$RepoWebUrl    = "https://github.com/tigermed-jimmy/tigermed-multica"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/tigermed-jimmy/tigermed-multica/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $url = "https://github.com/tigermed-jimmy/tigermed-multica/releases/download/$latest/multica-cli-$version-windows-$arch.zip"
    ...
    $checksumUrl = "https://github.com/tigermed-jimmy/tigermed-multica/releases/download/$latest/checksums.txt"
    try {
...
function Start-DefaultInstall {
    ...
    Write-Host ""
    Write-Host "     multica setup               " -NoNewline; Write-Host "# Connect to https://aicoding.tigermed.net" -ForegroundColor DarkGray
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/tigermed-jimmy/tigermed-multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/tigermed-jimmy/tigermed-multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
